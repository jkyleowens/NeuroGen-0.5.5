...
// Firing threshold for Izhikevich model.
// When a neuron's potential reaches this value, it is considered to have fired a spike.
constexpr float SPIKE_THRESHOLD = 30.0f;
