...
namespace NeuronModelConstants {
    ...
    static __device__ constexpr float SPIKE_THRESHOLD = 30.0f;
    static __device__ constexpr float RESTING_POTENTIAL = -65.0f;
    // ...

    // >>> FIX: Added missing constants for neuromodulation effects.
    ...
    static __device__ constexpr float HOMEOSTATIC_TIMESCALE = 1000.0f;
    // (And all other existing constants...)
